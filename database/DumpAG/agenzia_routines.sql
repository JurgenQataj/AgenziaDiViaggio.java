...
BEGIN
    INSERT INTO Pernottamento (data_inizio, viaggio, data_fine, localita)
    VALUES (_data_inizio, _viaggio, _data_fine, _localita);
...
BEGIN
    ...
    -- Recupera la data di rientro del viaggio
    ...
    -- Recupera i dati relativi ai partecipanti e guadagni
    SELECT V.titolo,
    ...
    -- Recupera i dati relativi ai pernottamenti
...
-- Dump completed on 2025-06-22 18:32:32
